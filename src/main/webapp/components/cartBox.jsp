...
<div class="div-myProduct">
  ...
  <div class="productPrice">
    ...
    <span
      id="productPrice_<%out.print(product.getUrunId());%>"
      class="fiyat"
      ><%out.print(product.getUrunFiyat());%></span
    ><span class="fiyatText money"> TL</span>
  </div>
  <div class="form">
    ...
    <input
      ...
      name="stockNum"
      value="1"
      max="<%out.print(product.getUrunStok());%>"
      min="1"
    />
    <form
      method="get"
    ...
    >
      <input
        type="hidden"
        name="productId"
        value="<%out.print(product.getUrunId());%>"
      />
      <button
        type="submit"
        class="delete-button"
